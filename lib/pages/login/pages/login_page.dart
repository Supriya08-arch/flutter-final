...
class _LoginPageState extends State<LoginPage> {
  ...
  final _emailController = TextEditingController(text: 'Obsess@gmail.com');
  final _passwordController = TextEditingController(text: 'Obsess@08');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(221, 255, 94, 0),
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  "Get started with details to login",
                  style: Theme.of(context)
                      .textTheme
                      .subtitle1!
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    primary: const Color.fromARGB(179, 0, 0, 0),
